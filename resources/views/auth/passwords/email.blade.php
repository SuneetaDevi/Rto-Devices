...
@section('meta')
    <meta property="og:title" content="Forgot Password | RTO Devices" />
    ...
    <div class="login-section pt-8 pb-8" style="min-height: 82vh;">
        <div class="container">
                    ...
                    <form method="POST" action="{{ route('password.email') }}" autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" autofocus class="form-control"
                                placeholder="{{__('auth.registration.your_mail')}}" autocomplete="off" required>
                        </div>
            ...
            <div class=" text-center mt-4 send_back">
                <p class="m-0">{{__('auth.forgot_password.send_me_back')}} <a
                        href="{{route('login')}}">{{__('auth.sign_in')}}</a> {{__('auth.forgot_password.screen')}}.</p>
            </div>
        </div>
    </div>
    <!-- ======================= Forgot password end  ============================ -->
