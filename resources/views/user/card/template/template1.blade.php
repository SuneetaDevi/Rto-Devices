...
<div class="template mb-3">
    <div class="banner mb-4 position-relative"
        ...
        <div class="user_pic" id="preview_profile">
            <img src="{{asset($card->profile_image ?? 'assets/images/avatar.png')}}" width="120"
                class="rounded-pill img-fluid" alt="Profile Image">
        </div>
    </div>
    ...
    <div class="px-4 pt-4 pb-2">
        <div class="profile_info mt-5 text-center">
            ...
            <h4><span id="preview_designation">{{$card->job_title ?? 'UI/UX Designer'}}</span> <span
