                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" id="title" value="{{ old('title') }}"
                                                    class="form-control" placeholder="Enter your post title" required>
                                            </div>
                                        </div>
                                        <!-- <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label for="title" class="form-lable">Tags</label>
                                                        <input type="text" name="tags[]" id="tags" class="form-control tags"
                                                            data-role="tagsinput" required="required" placeholder="Tags">
                                                    </div>
                                                </div> -->
                                        <div class="col-lg-6">
                                            <div class="form-group">
