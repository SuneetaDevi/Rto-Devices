                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <img class="custom-img mt-2" src="{{ asset($row->image) }}" alt="Paris"
                                                    width="60" height="80">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    <option value="1" {{ $row->status == 1 ? "selected" : "" }}>Published
                                                    </option>
                                                    <option value="0" {{ $row->status == 0 ? "selected" : "" }}>Unpublished
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="details" id="summernote" class="summernote" cols="30"
                                                    rows="5" class="form-control">{{ $row->details }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
