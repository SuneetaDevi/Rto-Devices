    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.request-demo.index') }}" class="nav-link  @yield('request_demo')" title="">
                        <i class="nav-icon fa fa-clipboard-list"></i>
                        <p>Demo Requests</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.partner-request.index') }}" class="nav-link  @yield('partner_application')"
                        title="">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.tenant.index') }}" class="nav-link @yield('tenant-active')"
                        title="Tenants">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.newsletter.index') }}" class="nav-link @yield('newsletter-active')"
                        title="Subscribers">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.user.index') }}" class="nav-link @yield('admin-user')" title="">
                ...
                @if (Auth::user()->can('admin.roles.index'))
                    <li class="nav-item">
                        <a href="{{ route('admin.roles.index') }}" class="nav-link @yield('admin-roles')" title="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                class="nav-icon">
                ...
                {{-- <li class="nav-item">
                    <a href="{{ route('admin.permissions.index') }}" class="nav-link @yield('admin-permissions')">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32"
                            class="nav-icon">
                            <path fill="white" d="M12 4a5 5 0 1 1-5 5a5 5 0 0 1
