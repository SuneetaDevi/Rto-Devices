                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <img src="{{getProfile($testimonial->image)}}" alt="" width="100"
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <label for="name"
                                                    class="form-lable">{{__('messages.customer.user_name')}}<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" name="name" id="name"
                                                    placeholder="{{__('messages.customer.enter_user_name')}}"
                                                    class="form-control" required value="{{ $testimonial->name }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <label for="designation"
                                                    class="form-lable">{{__('messages.common.designation')}}<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" name="designation" id="designation"
                                                    placeholder="{{__('messages.common.designation')}}" class="form-control"
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="order_id" id="order_id"
                                                    value="{{ $testimonial->order_id }}" class="form-control"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="details"
                                                    class="form-lable">{{__('messages.common.message')}}</label>
                                                <textarea name="details" id="details" class="form-control"
                                                    placeholder="{{__('messages.common.message')}}" cols="30"
                                                    rows="10"> {{ $testimonial->details }} </textarea>
                                            </div>
                                        </div>
                                        <!-- <div class="col-lg-12">
                                            <div class="form-group">
