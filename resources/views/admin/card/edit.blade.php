                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="">
                                        <a href="{{route('admin.card.index')}}"
                                            class="btn btn-sm btn-primary btn-gradient">Back</a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.card.update', $card->id)}}" method="post"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="self_branding" value="{{$card->self_branding}}"
                                                        class="form-control cin preview_branding"
                                                        data-preview="preview_branding"
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <label for="calendly"
                                                class="form-label">{{__('messages.card.calendly')}}</label>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="url" name="xing" value="{{$card->icons->xing}}"
                                                placeholder="ex: https://www.xing.com/RTO Devices"
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="url" name="telegram" value="{{$card->icons->telegram}}"
                                                placeholder="ex: https://t.me/RTO Devices" class="form-control icon_in"
                                                data-icon="telegram">
                                        </div>
                                        <div class="col-md-6 mb-2">
