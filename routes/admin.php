...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['auth:admin'], 'where' => ['locale' => '[a-zA-Z]{2}']], function () {
    ...
    Route::group(['prefix' => 'tenant', 'as' => 'tenant.'], function () {
        ...
        Route::post('{id}/suspensionToggle', [TenantController::class, 'suspensionToggle'])->name('suspensionToggle');
        Route::get('{id}/users', [TenantController::class, 'users'])->name('users');
        Route::get('/user/{id}/edit', [TenantController::class, 'userEdit'])->name('user.edit');
        Route::delete('/user/{id}/destroy', [TenantController::class, 'userdestroy'])->name('user.destroy');
        Route::put('/user/password/{id}', [TenantController::class, 'userchangePassword'])->name('user.password');
        Route::post('/{tenant}/user/store', [TenantController::class, 'userStore'])->name('user.store');

        Route::post('{id}/update', [TenantController::class, 'update'])->name('update');
        Route::get('{id}/delete', [TenantController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::group(['prefix' => 'newsletter', 'as' => 'newsletter.'], function () {
        ...
        Route::get('{id}/view', [NewsLetterController::class, 'view'])->name('view');
        Route::get('{id}/delete', [NewsLetterController::class, 'delete'])->name('delete');
    });
    ...
    Route::group(['prefix' => 'request-demo', 'as' => 'request-demo.'], function () {
        Route::get('/', [RequestDemoController::class, 'index'])->name('index');
        Route::post('/approve', [RequestDemoController::class, 'approve'])->name('approve');

        // Route::get('create', [RequestDemoController::class, 'create'])->name('create');
        // Route::post('store', [RequestDemoController::class, 'store'])->name('store');
        // Route::get('{id}/edit', [RequestDemoController::class, 'edit'])->name('edit');
        // Route::post('{id}/update', [RequestDemoController::class, 'update'])->name('update');
        Route::get('{id}/view', [RequestDemoController::class, 'view'])->name('view');
        Route::get('{id}/delete', [RequestDemoController::class, 'delete'])->name('delete');
    });
    Route::group(['prefix' => 'partner-request', 'as' => 'partner-request.'], function () {
        Route::get('/', [PartnerApplicationController::class, 'index'])->name('index');
        // Route::post('/approve', [PartnerApplicationController::class, 'approve'])->name('approve');
        Route::get('{id}/view', [PartnerApplicationController::class, 'view'])->name('view');
        Route::get('{id}/delete', [PartnerApplicationController::class, 'delete'])->name('delete');
    });
