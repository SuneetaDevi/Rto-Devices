...
class DashboardController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $data['tenants'] = Tenant::all();               // Total tenants
        $data['demo_requests'] = RequestDemo::all();    // Total demo requests
        $data['subscribers'] = Newsletter::all();      // Total subscribers
        $data['contacts'] = Contact::all();            // Total contact messages
